...
class replicaMaster
{
  ...
  constructor(){
    ...
    /*
    let tmp = [
      fileCtrol.checksumFile('./www/tmp/index.html'),
      fileCtrol.checksumFile('./www/tmp/imgs/alf.jpg'),
      fileCtrol.checksumFile('./www/tmp/imgs/inspector.jpg')    
    ];

    Promise.all(tmp).then((lista)=>{
      console.log('lista',tmp);
    });*/
